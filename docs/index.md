...
features:
  - icon: 🔌
    title: 多协议支持
    details: SOCKS5、HTTP CONNECT、VLESS、Hysteria2、Shadowsocks、Trojan 等，全部原生实现，无外部依赖。
  - icon: 🧭
    title: 智能路由
...
**v0.0.6** — TCP 全协议支撑，Hysteria2/Shadowsocks UDP，selector/fallback/urltest 出站组，Mieru 协议支持。
...
应用层 (浏览器 / curl / 系统代理)
  ...
  ▼
┌─────────────────────────────┐
│ Inbound                     │ socks5 · http-connect · mixed · vless · hysteria2 · ss · trojan · vmess · mieru
├─────────────────────────────┤
│ Router                      │ domain · ip · geoip · keyword · rule-set · and · or
├─────────────────────────────┤
│ Outbound Group              │ selector · fallback · urltest
├─────────────────────────────┤
│ Outbound                    │ direct · block · socks5 · vless · hysteria2 · ss · trojan · vmess · mieru
└─────────────────────────────┘
  │                            │
  ▼                            ▼
┌──────────────┐   ┌──────────────────┐
