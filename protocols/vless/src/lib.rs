...
pub use outbound::{
    establish_udp_packet_tunnel, VlessOutbound, VlessTcpTunnelTarget, VlessUdpPacketTarget,
...
pub use shared::{
    ...
    parse_udp_packet, parse_udp_packet_v2, parse_uuid, VlessUdpFlowCodec, VlessUdpPacket,
    VLESS_VERSION,
};
