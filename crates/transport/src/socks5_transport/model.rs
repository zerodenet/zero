...
pub struct Socks5ManagedUdpFlowConfig<'a> {
    pub(super) protocol: socks5::udp::Socks5UdpFlowConfig<'a>,
}

#[derive(Clone)]
pub struct OwnedSocks5InboundAcceptor {
    pub(super) protocol: socks5::Socks5InboundTcpAcceptor,
}
...
pub struct Socks5InboundUdpAssociationHandler {
    pub(super) protocol: socks5::udp::Socks5InboundUdpAssociationSession,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Socks5ManagedUdpAssociationTarget {
    pub(super) protocol: socks5::udp::Socks5UdpAssociationTarget,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Socks5ManagedUdpPacketPathCarrierBuild {
    pub(super) protocol: socks5::udp::Socks5UdpPacketPathCarrierBuild,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Socks5ManagedUdpPacketPathCarrierDescriptor {
    pub(super) protocol: socks5::udp::Socks5UdpPacketPathCarrierDescriptor,
}
...
impl Socks5ManagedUdpAssociationTarget {
    pub(super) fn new(protocol: socks5::udp::Socks5UdpAssociationTarget) -> Self {
        Self { protocol }
    }
    ...
    pub(super) fn into_protocol_target(self) -> socks5::udp::Socks5UdpAssociationTarget {
        self.protocol
    }
}

impl Socks5ManagedUdpPacketPathCarrierBuild {
    pub(super) fn new(protocol: socks5::udp::Socks5UdpPacketPathCarrierBuild) -> Self {
        Self { protocol }
    }

    pub(super) fn into_protocol_build(self) -> socks5::udp::Socks5UdpPacketPathCarrierBuild {
        self.protocol
    }
}
