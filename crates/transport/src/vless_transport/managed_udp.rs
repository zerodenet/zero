...
type VlessManagedUdpConnectorFlow = ManagedConnectorFlow<vless::udp::VlessUdpConnectorFlow>;

pub type VlessManagedStreamUdpResume = ManagedTupleUdpResume<VlessManagedUdpFlowResume>;

impl ProtocolManagedStreamUdpResumeMetadata for VlessManagedStreamUdpResume {
...
impl VlessManagedUdpFlowResume {
    ...
    ) -> Result<vless::udp::VlessUdpFlowConnection, EngineError>
    where
...
impl ManagedConnectorFlowOps for vless::udp::VlessUdpConnectorFlow {
...
impl ProtocolManagedTupleUdpFlowResumeConnectionOps for VlessManagedUdpFlowResume {
    ...
    type RawConnection = vless::udp::VlessUdpFlowConnection;
...
impl ManagedTupleUdpConnectionOps for vless::udp::VlessUdpFlowConnection {
    ...
    async fn send_protocol_packet(
        ...
        vless::udp::VlessUdpFlowConnection::send(self, target, port, payload).await
    }

    fn subscribe_protocol_packets(&self) -> vless::udp::VlessUdpFlowResponseReceiver {
