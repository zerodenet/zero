...
pub struct ShadowsocksManagedDatagramFlowResume {
    pub(super) protocol: shadowsocks::udp::ShadowsocksUdpFlowResume,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ShadowsocksManagedUdpPacketPathCarrierDescriptor {
    pub(super) protocol: shadowsocks::udp::ShadowsocksUdpPacketPathCarrierDescriptor,
}

#[derive(Debug, Clone)]
pub struct ShadowsocksManagedUdpPacketPathDatagramSourceBuild {
    pub(super) protocol: shadowsocks::udp::ShadowsocksUdpPacketPathDatagramSourceBuild,
}
...
pub struct OwnedShadowsocksInboundProfile {
    pub(super) protocol: shadowsocks::ShadowsocksInboundProfile,
}

#[derive(Clone)]
pub struct OwnedShadowsocksInboundTcpAcceptor {
    pub(super) protocol: shadowsocks::ShadowsocksInboundTcpAcceptor,
}

pub struct OwnedShadowsocksInboundBindings {
    pub(super) acceptor: OwnedShadowsocksInboundTcpAcceptor,
    pub(super) udp_relay: shadowsocks::udp::ShadowsocksInboundUdpRelay,
}
...
impl ShadowsocksManagedDatagramFlowResume {
    ...
    pub(super) fn socket_flow_spec(&self) -> shadowsocks::udp::ShadowsocksUdpSocketFlowSpec {
